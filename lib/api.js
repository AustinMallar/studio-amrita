...
const CATEGORY_FALLBACK_DESCRIPTIONS = {
  ...
  "classic-glow-bear":
    "Our signature crochet bear keychain with Klavuu lip balm — soft, sweet, and ready to delight in every colour.",
  "baby-glow-bear":
    "A petite handmade baby glow bear keychain with lip balm — a sweet self-care accessory or thoughtful gift.",
  accessories:
