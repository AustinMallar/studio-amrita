...
- WooCommerce shipping zones and rates (Etsy shipping profiles are not imported). Glow Bear products should use the **Glow Bear** shipping class (`glow-bear`) for free shipping worldwide — the importer assigns this automatically for glow-bear category listings.
